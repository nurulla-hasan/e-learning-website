        ...
        <div className="space-y-8">
          ...
          <section>
            <p className="text-gray-700 leading-relaxed">
              Triplemcollectibles is committed to protecting your privacy. This Privacy Policy explains how we collect,
          ...
          <section>
            ...
            <div className="text-gray-700 leading-relaxed space-y-2 pl-4">
              <p>When you visit our site or place an order, we may collect the following information:</p>
              <p>• Personal Information: Name, email address, phone number, billing and shipping addresses.</p>
              <p>• Payment Information: Payment method details (handled securely via third-party processors).</p>
              <p>• Order History: Products purchased, quantities, and shipping details.</p>
              <p>• Device Information: IP address, browser type, time zone, pages viewed, and other analytics data.</p>
              <p>• Marketing Data: Preferences, reviews, or feedback you voluntarily provide.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-700 leading-relaxed space-y-2 pl-4">
              ...
              <p>• Communicate with you about orders, returns, or account updates</p>
          ...
          <section>
            ...
            <div className="text-gray-700 leading-relaxed space-y-2 pl-4">
              <p>
                We do not sell your personal information. However, we may share data with trusted third parties to
                fulfill your orders or operate our services such as:
              </p>
              ...
              <p>• All partners are required to protect your data under applicable laws</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-700 leading-relaxed space-y-2 pl-4">
              <p>
                • We use cookies and similar tracking tools to improve your browsing experience, remember your
